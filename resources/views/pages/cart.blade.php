                ...
                <div class="col-12 table-responsive">
                    <table class="table table-borderless table-cart" aria-describedby="Cart">
                        ...
                        <tbody>
                            <tr>
                                <td style="width: 25%;">
                                    <img src="/public/images/product-cart-1.jpg" alt="" class="cart-image" />
                                </td>
                                <td style="width: 35%;">
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    <img src="/public/images/product-cart-2.jpg" alt="" class="cart-image" />
                                </td>
                                <td style="width: 25%;">
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    <img src="/public/images/product-cart-3.jpg" alt="" class="cart-image" />
                                </td>
                                <td style="width: 25%;">
