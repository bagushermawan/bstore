                    ...
                    <div class="row">
                        <div class="col-12 col-lg-8">
                            <ul class="list-unstyled">
                                <li class="media">
                                    <img src="/public/images/icon-testimonial-1.png" class="mr-3 rounded-circle"
                                        alt="" />
                                ...
                                <li class="media my-4">
                                    <img src="/public/images/icon-testimonial-2.png" class="mr-3 rounded-circle"
                                        alt="" />
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img src="/public/images/icon-testimonial-3.png" class="mr-3 rounded-circle"
                                        alt="" />
                                    <div class="media-body">
      ...
      var gallery = new Vue({
        ...
        data: {
          ...
          photos: [
            {
              id: 1,
              url: "/public/images/product-details-1.jpg",
            },
            {
              id: 2,
              url: "/public/images/product-details-2.jpg",
            },
            {
              id: 3,
              url: "/public/images/product-details-3.jpg",
            },
            {
              id: 4,
              url: "/public/images/product-details-4.jpg",
            },
          ],
        },
        methods: {
